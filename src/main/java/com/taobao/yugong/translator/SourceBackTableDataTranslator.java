 ...
 */
public abstract class SourceBackTableDataTranslator extends BackTableDataTranslator  {
  ...
  public abstract boolean translator(DataSource sourceDs, DataSource targetDs, Record record) ;
          ...
          public void run() {
            ...
            try {
              ...
              Thread.currentThread().setName(this.getClass().getSimpleName()
                  ...
                  record.getTableName()), '.'));
              if (translator(sourceDs, targetDs, record)) {
                result.add(record);
              }
            } catch (Throwable e) {
